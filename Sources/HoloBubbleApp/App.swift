...
struct ContentView: View {
    ...
    @State private var backendURL: String = "https://your-server.example.com/analyze"
    ...
    var body: some View {
        ...
        .onChange(of: backendURL) { newValue in
            bubbleController.backendClient.backendURL = URL(string: newValue)
        }
        .onAppear {
            bubbleController.backendClient.backendURL = URL(string: backendURL)
        }
        .background(
